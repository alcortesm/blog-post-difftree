...
-   **Modified file**: Both trees have the same topology, but the hash of the
    ...
    !["The index contents before and after lib/lib.go is modified](./images/modified.png "The index before and after lib/lib.go is modified, changed hashes are shown in red.")
...
-   **Renamed file** (the name of the file has changed, but it has not been
    ...
    !["The index contents before and after lib/lib.go is renamed to lib/foo.go](./images/renamed.png "Renamed file.")
...
-   **Inserted file**: The topology of A and B is different, the parent
    ...
    !["The index contents before and after lib/foo.go is inserted](./images/inserted.png "Inserted file.")
...
-   **Deleted file**: The topology of A and B is different, the parent directory
    ...
    !["The index contents before and after lib/lib.go has been deleted](./images/deleted.png "Deleted file.")
